...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/hd_logonew.jpg"></a> Pharmacy Management System</h1></div>
<div id="left_column">
<div id="button">
		<ul>
...
<hr/>	
    <div class="tabbed_area" style="width:110%">  
		...
		{	
			...
			if(invoice_no.length >0)		
			
				{
					$.ajax(
				{
type: "POST", url: "check.php", data: 'invoice_no='+invoice_no+'&amount='+amount+"&payment_type="+payment_type+"&serial_no"+serial_no, success: function(msg)
		...
		echo"</select>";?>  </td></tr>
				...
				<tr><td><input name="tuma" id="submit" type="submit" value="submit"/></td></tr>
            </table>
		</form>         
        </div>  
    </div>  
